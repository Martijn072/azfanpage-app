    ...
    return (
      <div ref={ref} style={{ width: 1080, height: 1080 }} className="relative overflow-hidden flex flex-col">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center flex-1 px-16">
          <span className="text-[#DB0021] text-xl font-body font-semibold uppercase tracking-[0.25em] mb-2">
            Voorbeschouwing
          </span>

          <div className="flex items-center gap-3 mb-20">
            <img src={league.logo} alt={league.name} className="h-8 w-8 object-contain" />
            <span className="text-white/70 text-lg font-body">{league.name} · {league.round}</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-16 w-full">
            ...
            <span className="text-white/40 font-mono text-6xl font-light">VS</span>
          ...
          <div className="mt-20 flex flex-col items-center gap-2">
            ...
            <span className="text-white/70 text-lg font-body capitalize">{matchDate}</span>
            {fixture.fixture.venue && (
              <span className="text-white/50 text-lg font-body mt-1">
